...
export const SaleCard: React.FC<SaleCardProps> = ({ className = "", product }) => (
    <div className={`${className} saleCard`}>
        ...
        <div className="info">
            ...
            <span>
                <p className="text">Stock: {`${product?.stock}`} -  ${`${product?.price}`}</p>
                <p className="text">{`${product?.brand?.name}`} - {`${product?.category?.name}`}</p>
            </span>
        </div>
        <div className="btnContainerSales">
            ...
            <div className="quantity">
                ...
                <ShoppingCartIcon className="cartIcon" /></div>
